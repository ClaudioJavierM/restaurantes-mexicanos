...
return [
    ...
    'attributes' => [
        'submitter_name'     => 'tu nombre',
        'submitter_email'    => 'tu correo electrónico',
        'restaurant_name'    => 'nombre del restaurante',
        'restaurant_address' => 'dirección',
        'restaurant_city'    => 'ciudad',
        'restaurant_state'   => 'estado',
        'category_id'        => 'tipo de comida',
        'restaurant_phone'   => 'teléfono',
        'restaurant_website' => 'sitio web',
    ],
];
