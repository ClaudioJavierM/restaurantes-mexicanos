...
<body class="bg-gray-900 min-h-screen">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-4">
                    @auth
                        ...
                        @endif
                        <a id="onboarding-profile" href="{{ route('profile') }}" class="text-gray-400 hover:text-white">
        ...
        <aside class="w-64 bg-gray-800 border-r border-gray-700 min-h-[calc(100vh-4rem)] hidden lg:block">
            <div class="p-4">
                ...
                <nav class="space-y-1">
                    ...
                    <a id="onboarding-reviews" href="{{ route('owner.reviews', $restaurant) }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.reviews') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.915c.969 0 1.371 1.24.588 1.81l-3.976 2.888a1 1 0 00-.363 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.976-2.888a1 1 0 00-1.176 0l-3.976 2.888c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.363-1.118l-3.976-2.888c-.784-.57-.38-1.81.588-1.81h4.914a1 1 0 00.951-.69l1.519-4.674z"/></svg>
                        <span>Resenas</span>
                    </a>
                    <a id="onboarding-menu" href="{{ route('owner.menu', $restaurant) }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.menu') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700 hover:text-white' }}">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg>
                        <span>Menu</span>
                    </a>
                    <a id="onboarding-analytics" href="{{ route('owner.famer', $restaurant) }}" class="flex items-center gap-3 px-3 py-2 rounded-lg {{ request()->routeIs('owner.famer') ? 'bg-gray-700 text-white' : 'text-gray-400 hover:bg-gray-700 hover:text-white' }}">
    ...
    @livewire('owner.onboarding-tour')
    @livewireScripts
