                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex gap-2">
                            <button wire:click="voteHelpful({{ $review->id }})"
                                    class="flex items-center gap-1 px-3 py-1.5 rounded-lg border {{ $review->getUserVote()?->is_helpful === true ? 'border-green-500 bg-green-900/30 text-green-400' : 'border-gray-300 bg-white text-black hover:bg-gray-100' }} transition-colors">
                            ...
                            <button wire:click="voteNotHelpful({{ $review->id }})"
                                    class="flex items-center gap-1 px-3 py-1.5 rounded-lg border {{ $review->getUserVote()?->is_helpful === false ? 'border-red-500 bg-red-900/30 text-red-400' : 'border-gray-300 bg-white text-black hover:bg-gray-100' }} transition-colors">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
