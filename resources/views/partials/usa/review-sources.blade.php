...
<div class="bg-gradient-to-r from-orange-50 to-amber-50 py-8 border-b border-orange-100">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="flex flex-wrap justify-center items-center gap-6 md:gap-10">
            ...
            <span class="text-xl md:text-2xl font-bold text-rose-500">Grubhub</span>
            <span class="text-xl md:text-2xl font-bold text-purple-600">Foursquare</span>
        </div>
    </div>
</div>
